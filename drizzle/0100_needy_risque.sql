...
--> statement-breakpoint
ALTER TABLE "library_resources" DISABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
CREATE INDEX "fk_publication_authors_publication" ON "publication_authors" USING btree ("publication_id");--> statement-breakpoint
CREATE INDEX "fk_publication_authors_author" ON "publication_authors" USING btree ("author_id");--> statement-breakpoint
