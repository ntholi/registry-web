...
CREATE TYPE "public"."education_level" AS ENUM('JCE', 'BJCE', 'BGGSE', 'LGCSE', 'IGCSE', 'O-Levels', 'A-Levels', 'Matriculation', 'COSC', 'Certificate', 'Diploma', 'Degree', 'Masters', 'Doctorate', 'Others');--> statement-breakpoint
