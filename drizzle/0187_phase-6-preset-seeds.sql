...
VALUES
  ...
  ('8G4nTJqL4n6VyJi6TWr1c', 'Academic Program Leader', 'teaching-observations', 'read'),
  ('rDyrv0JkAGXH2r8qz9ijQ', 'Academic Program Leader', 'teaching-observations', 'create'),
  ('x30Lj46SiRUyU7fwycqnP', 'Academic Program Leader', 'teaching-observations', 'update'),
  ('VMwVOjNFF7u49DL0Ofgrk', 'Academic Program Leader', 'teaching-observations', 'delete'),
  ('kk6djXyPfOAuocAAmQWN7', 'Academic Program Leader', 'teaching-observation-criteria', 'read'),
  ('B2ftDGDtMterePwVPUF_z', 'Academic Program Leader', 'teaching-observation-reports', 'read'),
  ('GwltkZPQC1zSsGVBHaLeQ', 'Academic Program Leader', 'student-statuses', 'approve'),
  ('aPL2xCdEfGhIjKlMnOpQ2', 'Academic Program Leader', 'mails', 'read'),
  ...
  ('EoTQDwQMAEoK9md_mZ1TF', 'Academic Year Leader', 'teaching-observations', 'read'),
  ('GDyuYbvX6apYN8HwwfxdX', 'Academic Year Leader', 'student-statuses', 'approve'),
  ('aYL3xDdEfGhIjKlMnOpQ3', 'Academic Year Leader', 'mails', 'read'),
  ...
  ('JCXAeb-OSIo41uT7s0MiL', 'Academic Lecturer', 'teaching-observations', 'read'),
  ('aL4xEdFgHiJkLmNoPqRs4', 'Academic Lecturer', 'mails', 'read'),
  ...
  ('H9U5RlrxJdWV6J11pcbyL', 'Academic Principal Lecturer', 'teaching-observations', 'read'),
  ('aP1xBcDeFgHiJkLmNoPqR', 'Academic Principal Lecturer', 'teaching-observations', 'create'),
  ('bQ2yCdEfGhIjKlMnOpQrS', 'Academic Principal Lecturer', 'teaching-observations', 'update'),
  ('cR3zDeEfGhIjKlMnOpQrT', 'Academic Principal Lecturer', 'teaching-observations', 'delete'),
  ('dS4AeFfGhIjKlMnOpQrTU', 'Academic Principal Lecturer', 'teaching-observation-criteria', 'read'),
  ('eT5BfGgHiJkLmNoPqRsUV', 'Academic Principal Lecturer', 'users', 'read'),
  ('KAdYgmdUk2Rd8GJHZzqsu', 'Academic Principal Lecturer', 'teaching-observation-reports', 'read'),
  ('aPrL5FgHiJkLmNoPqRsT5', 'Academic Principal Lecturer', 'mails', 'read'),
...
BEGIN
  ...
  WITH expected AS (
      ...
      ('Academic Program Leader', 'tasks', 'delete'),
			...
			('Academic Program Leader', 'teaching-observations', 'read'),
			('Academic Program Leader', 'teaching-observations', 'create'),
			('Academic Program Leader', 'teaching-observations', 'update'),
			('Academic Program Leader', 'teaching-observations', 'delete'),
			('Academic Program Leader', 'teaching-observation-criteria', 'read'),
			('Academic Program Leader', 'teaching-observation-reports', 'read'),
			('Academic Program Leader', 'student-statuses', 'approve'),
			('Academic Program Leader', 'mails', 'read'),
      ...
      ('Academic Year Leader', 'tasks', 'delete'),
			...
			('Academic Year Leader', 'teaching-observations', 'read'),
			('Academic Year Leader', 'student-statuses', 'approve'),
			('Academic Year Leader', 'mails', 'read'),
      ...
      ('Academic Lecturer', 'tasks', 'delete'),
			...
			('Academic Lecturer', 'teaching-observations', 'read'),
			('Academic Lecturer', 'mails', 'read'),
      ...
      ('Academic Principal Lecturer', 'tasks', 'delete'),
			...
			('Academic Principal Lecturer', 'teaching-observations', 'read'),
			('Academic Principal Lecturer', 'teaching-observation-reports', 'read'),
			('Academic Principal Lecturer', 'mails', 'read'),
