-- Add title column to observation_criteria
ALTER TABLE "observation_criteria" ADD COLUMN IF NOT EXISTS "title" text;
...
INSERT INTO "observation_criteria" ("id", "category_id", "title", "text", "description", "sort_order") VALUES
...
ON CONFLICT ("id") DO UPDATE SET "title" = EXCLUDED."title", "text" = EXCLUDED."text", "description" = EXCLUDED."description";
...
INSERT INTO "observation_criteria" ("id", "category_id", "title", "text", "description", "sort_order") VALUES
  ('crit_as_1', 'cat_assess', 'Timeliness', 'Sets appropriate student assessments and issues them on time', NULL, 0),
  ('crit_as_2', 'cat_assess', 'Progress Monitoring', 'Analyzes student''s progress records, monitors and takes remedial measures', NULL, 1),
  ('crit_as_3', 'cat_assess', 'Feedback', 'Gives students feedback on time', NULL, 2)
ON CONFLICT ("id") DO UPDATE SET "title" = EXCLUDED."title", "text" = EXCLUDED."text", "description" = EXCLUDED."description";

-- Section 3: Other
INSERT INTO "observation_criteria" ("id", "category_id", "title", "text", "description", "sort_order") VALUES
  ('crit_ot_1', 'cat_other', 'Course Files', 'Lecturer has complete course files', NULL, 0)
ON CONFLICT ("id") DO UPDATE SET "title" = EXCLUDED."title", "text" = EXCLUDED."text", "description" = EXCLUDED."description";