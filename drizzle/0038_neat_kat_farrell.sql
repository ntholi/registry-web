...
INSERT INTO `__new_academic_user_schools`("id", "user_id", "school_id", "created_at") SELECT "id", "academic_user_id", "school_id", "created_at" FROM `academic_user_schools`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_assigned_modules`("id", "user_id", "module_id", "structure_semester_id", "created_at") SELECT "id", "academic_user_id", "module_id", "structure_semester_id", "created_at" FROM `assigned_modules`;--> statement-breakpoint
