...
ALTER TABLE "feedback_cycles" ADD CONSTRAINT "feedback_cycles_term_id_terms_id_fk" FOREIGN KEY ("term_id") REFERENCES "public"."terms"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_feedback_passphrases_cycle_class" ON "feedback_passphrases" USING btree ("cycle_id","structure_semester_id");