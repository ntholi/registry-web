    ...
    <Box pos='relative'>
      ...
      <Stack gap='lg'>
        <Text size='lg' c='dimmed' ta='center'>
          Please review your information before submitting your graduation request.
        </Text>
        ...
        <Card withBorder shadow='sm' radius='md' padding='lg'>
          <Group mb='md'>
            ...
            <Badge color='green' variant='light'>Confirmed</Badge>
          </Group>
          ...
          <Stack gap='sm'>
            ...
            <Group>
              ...
              <Text size='sm' c='dimmed' w={120}>National ID:</Text>
              <Text fw={500}>
            ...
            <Group>
              ...
              <Text size='sm' c='dimmed' w={120}>Gender:</Text>
              <Text fw={500}>
            ...
            <Group>
              <IconId size='1rem' color='gray' />
              <Text size='sm' c='dimmed' w={120}>Student No:</Text>
              <Text fw={500}>
                {student.stdNo}
              </Text>
            </Group>
        ...
        <Card withBorder shadow='sm' radius='md' padding='lg' bg='blue.0'>
          ...
          <Stack gap='sm'>
            <Group>
              <Text size='sm' fw={500} c='blue.7'>1.</Text>
              <Text size='sm' c='blue.7'>
                Your graduation request will be submitted to the Registry Department
              </Text>
            </Group>
            
            <Group>
              <Text size='sm' fw={500} c='blue.7'>2.</Text>
              <Text size='sm' c='blue.7'>
            ...
            <Group>
              <Text size='sm' fw={500} c='blue.7'>3.</Text>
              <Text size='sm' c='blue.7'>
            ...
            <Group>
              <Text size='sm' fw={500} c='blue.7'>4.</Text>
              <Text size='sm' c='blue.7'>
        ...
        <Text size='sm' c='dimmed' ta='center'>
          ...
          and complete. Click "Submit Graduation Request" to proceed.
        </Text>
      </Stack>
    </Box>
  );
