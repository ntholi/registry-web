  ...
  return (
    <Stack gap='lg'>
      ...
      <Alert
        ...
        title='IMPORTANT - Verify Your Information'
        color='red'
        variant='filled'
      >
        <Stack gap='sm'>
          ...
          <Text fw={700}>
            ⚠️ If this information is NOT correct, you MUST report to the
            Registry Department BEFORE the clearance deadline.
          </Text>
          <Text>
            ❌ This information CANNOT be corrected after the clearance deadline
            has passed.
          </Text>
        </Stack>
      </Alert>
      ...
      <Card withBorder shadow='sm' radius='md' padding='lg'>
        ...
        <Stack gap='md'>
          ...
          <Group>
            {student.gender === 'Male' ? (
              <IconGenderMale size='1.2rem' color='blue' />
            ) : (
              <IconGenderFemale size='1.2rem' color='pink' />
            )}
            <Box>
              <Text size='sm' c='dimmed'>
                Gender
      ...
      <Card withBorder shadow='sm' radius='md' padding='lg'>
        ...
        <Stack gap='md'>
          <Text>
            To proceed with your graduation request, please verify that ALL the
