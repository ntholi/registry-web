...
export const getTermSettings = createAction(async (termId: number) =>
	service.findByTermId(termId)
);

export const updateResultsPublished = createAction(
	async (termId: number, published: boolean) =>
		service.updateResultsPublished(termId, published)
);
...
export const updateGradebookAccess = createAction(
	async (termId: number, access: boolean) =>
		service.updateGradebookAccess(termId, access)
);

export const moveRejectedToBlocked = createAction(async (termId: number) =>
	service.moveRejectedToBlocked(termId)
);

export const getUnpublishedTermCodes = createAction(async () =>
	service.getUnpublishedTermCodes()
);

export const getPublicationAttachments = createAction(
...
export const savePublicationAttachment = createAction(
	async (data: {
		...
		storageKey?: string;
	}) => service.createPublicationAttachment(data)
);
...
export const deletePublicationAttachment = createAction(async (id: string) =>
	service.deletePublicationAttachment(id)
);
