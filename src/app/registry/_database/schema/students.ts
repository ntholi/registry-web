import { grade } from '@academic/_database/schema/enums';
import { semesterModules } from '@academic/_database/schema/modules';
import {
	structureSemesters,
	structures,
} from '@academic/_database/schema/structures';
