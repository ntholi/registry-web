...
import { getLetterPrintHistory } from '../_server/actions';
...
export default function LetterPrintHistoryView({ letterId, isActive }: Props) {
	const { data: prints, isLoading } = useQuery({
		queryKey: ['letter-print-history', letterId],
		queryFn: () => getLetterPrintHistory(letterId),
		enabled: isActive,
	});
