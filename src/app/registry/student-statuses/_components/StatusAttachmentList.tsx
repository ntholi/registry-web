...
import type { studentStatusAttachments } from '@/core/database';
...
import {
	deleteStatusAttachment,
	uploadStatusAttachment,
} from '../_server/actions';

type Attachment = typeof studentStatusAttachments.$inferSelect;
...
export default function StatusAttachmentList({
	...
	const uploadMutation = useMutation({
		mutationFn: async (file: File) => {
			...
			return uploadStatusAttachment(statusId, formData);
		},
		onSuccess: async () => {
			await queryClient.invalidateQueries({
				queryKey: ['student-status', statusId],
			});
			notifications.show({
				title: 'Success',
	...
	const deleteMutation = useMutation({
		mutationFn: (id: string) => deleteStatusAttachment(id),
		onSuccess: async () => {
			await queryClient.invalidateQueries({
				queryKey: ['student-status', statusId],
			});
