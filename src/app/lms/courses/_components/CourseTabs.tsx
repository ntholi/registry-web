...
import MaterialForm from '@lms/material/_components/MaterialForm';
import MaterialList from '@lms/material/_components/MaterialList';
	...
	return (
		...
		>
			...
			<Tabs.Panel value='assignments' pt='lg'>
				<Box p='sm'>
					<AssignmentsList courseId={course.id} moduleId={moduleId} />
				</Box>
			</Tabs.Panel>
