...
import LmsAuthGuard from '@/modules/lms/features/auth/components/LmsAuthGuard';
...
export default function LmsLayout({ children }: PropsWithChildren) {
	...
	return (
		<Dashboard moduleConfig={moduleConfig}>
			...
			<LmsAuthGuard>{children}</LmsAuthGuard>
		</Dashboard>
	);
}
