		...
		<Box>
			...
			{selectedStudent && (
				<Text
					...
					size='xs'
					pl={2}
					c={selectedStudent.activeReservationsCount > 0 ? 'red' : 'blue'}
				>
					{selectedStudent.activeReservationsCount > 0
						? selectedStudent.activeReservationsCount
						: 'No '}{' '}
					active reservation
					{selectedStudent.activeReservationsCount !== 1 ? 's' : ''}
				</Text>
			)}
		</Box>
	);
