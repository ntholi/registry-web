...
import { checkGoogleSheetsAccess, populateGraduationList } from '@/server/lists/graduation/actions';
...
export default function PopulateButton({ listId, isPopulated, onSuccess }: PopulateButtonProps) {
	...
	return (
		<Button
			leftSection={isPopulated ? <IconRefresh size={16} /> : <IconFileSpreadsheet size={16} />}
			onClick={handleClick}
