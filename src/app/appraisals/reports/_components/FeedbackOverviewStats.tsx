...
import type { FeedbackOverviewStats as FeedbackOverviewStatsType } from '../_lib/types';

type Props = {
	data: FeedbackOverviewStatsType;
};
...
export default function FeedbackOverviewStats({ data }: Props) {
	return (
		<Grid gutter='md'>
