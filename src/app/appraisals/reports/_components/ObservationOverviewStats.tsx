...
import type { ObservationOverviewStats as ObservationOverviewStatsType } from '../_lib/types';

type Props = {
	data: ObservationOverviewStatsType;
};
...
export default function ObservationOverviewStats({ data }: Props) {
	return (
		<Grid gutter='md'>
