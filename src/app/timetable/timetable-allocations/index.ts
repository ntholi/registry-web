...
export {
	...
	type DayOfWeek,
	daysOfWeek,
} from './_components/AllocationForm';
export { default as AllocationTab } from './_components/AllocationTab';
export { default as EditAllocationModal } from './_components/EditAllocationModal';
export {
	ModuleSearchInput,
