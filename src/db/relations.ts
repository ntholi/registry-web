...
export const studentProgramsRelations = relations(studentPrograms, ({ many, one }) => ({
	student: one(students, {
...
export const studentSemestersRelations = relations(studentSemesters, ({ many, one }) => ({
...
export const structureSemestersRelations = relations(structureSemesters, ({ many, one }) => ({
	structure: one(structures, {
...
export const semesterModulesRelations = relations(semesterModules, ({ many, one }) => ({
...
export const statementOfResultsPrintsRelations = relations(statementOfResultsPrints, ({ one }) => ({
	student: one(students, {
...
export const transcriptPrintsRelations = relations(transcriptPrints, ({ one }) => ({
	student: one(students, {
...
export const studentCardPrintsRelations = relations(studentCardPrints, ({ one }) => ({
	student: one(students, {
...
export const graduationListsRelations = relations(graduationLists, ({ one }) => ({
...
export const registrationRequestsRelations = relations(registrationRequests, ({ many, one }) => ({
	student: one(students, {
...
export const requestedModulesRelations = relations(requestedModules, ({ one }) => ({
...
export const registrationClearanceRelations = relations(registrationClearance, ({ one }) => ({
	registrationRequest: one(registrationRequests, {
...
export const graduationClearanceRelations = relations(graduationClearance, ({ one }) => ({
	graduationRequest: one(graduationRequests, {
...
export const graduationRequestsRelations = relations(graduationRequests, ({ one, many }) => ({
	studentProgram: one(studentPrograms, {
...
export const sponsoredStudentsRelations = relations(sponsoredStudents, ({ one, many }) => ({
	sponsor: one(sponsors, {
...
export const assignedModulesRelations = relations(assignedModules, ({ one }) => ({
	user: one(users, {
...
export const assessmentMarksRelations = relations(assessmentMarks, ({ one, many }) => ({
...
export const assessmentMarksAuditRelations = relations(assessmentMarksAudit, ({ one }) => ({
...
export const assessmentsAuditRelations = relations(assessmentsAudit, ({ one }) => ({
	assessment: one(assessments, {
...
export const blockedStudentsRelations = relations(blockedStudents, ({ one }) => ({
	student: one(students, {
...
export const fortinetRegistrationsRelations = relations(fortinetRegistrations, ({ one }) => ({
	student: one(students, {
