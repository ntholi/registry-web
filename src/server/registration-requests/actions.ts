...
export async function findAllRegistrationRequests(page: number = 1, search = '') {
  return service.findAll({ page, search });
}

export async function createRegistrationRequest(registrationRequest: RegistrationRequest) {
  return service.create(registrationRequest);
}

export async function updateRegistrationRequest(id: number, registrationRequest: RegistrationRequest) {
