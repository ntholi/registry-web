...
> [!IMPORTANT]
> Read this entire document before starting any task. Adhere to all guidelines strictly. If you are unsure, ask for clarification.
...
- **Type Safety**: Avoid `any` at all costs. Use `interface` for object definitions and `type` for unions/intersections.
