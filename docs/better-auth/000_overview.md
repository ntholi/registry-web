...
| 24f | Core Platform Cleanup & Final Verification | `024f_phase-24-platform-cleanup.md` | `DONE` | `2026-03-13` | Removed legacy role-array support from core platform auth, migrated `DetailsViewHeader` to permission props, and completed final cleanup verification |
